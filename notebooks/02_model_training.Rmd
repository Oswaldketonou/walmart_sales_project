---
title: "02 — Model Training (Linear Regression + Random Forest Scaling)"
author: "Waldo Ketonou"
output: html_document
---

# Introduction
This notebook trains the forecasting models used in the Walmart Sales Forecasting Project. All data cleaning, feature engineering, and EDA were completed in PostgreSQL. The prepared modeling datasets (`train_df` and `test_df`) were generated in the previous step of the R workflow. This notebook trains:

- A baseline Linear Regression model  
- Three Random Forest models at increasing sample sizes (200k, 500k, 1M rows)

Performance is evaluated using RMSE, MAE, MAPE, and SMAPE.
...
# Baseline Linear Regression Mosel
```{r}
lm_model <- lm(
...
cat("MAPE :", mape_lm, "%\n")
cat("SMAPE:", smape_lm, "%\n")
# Randome Forest Scaling Experiments
```{r}
